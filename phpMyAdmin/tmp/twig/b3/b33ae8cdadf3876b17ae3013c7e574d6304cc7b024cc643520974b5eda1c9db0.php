...
class __TwigTemplate_d5a949e3598f219ed0af2e59aa0d888631bfa07f8f395632a1e3066f8cc9c707 extends Twig_Template
{
    ...
    <table class=\"data noclick\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["current_charset"]) {
            ...
            echo "
                    ";
            // line 13
            if ( !twig_test_empty($this->getAttribute((isset($context["mysql_charsets_desc"]) ? $context["mysql_charsets_desc"] : null), $context["current_charset"], [], "array"))) {
                // line 14
                echo "                        (<em>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mysql_charsets_desc"]) ? $context["mysql_charsets_desc"] : null), $context["current_charset"], [], "array"), "html", null, true);
                echo "</em>)
                    ";
            }
            // line 16
            ...
            // line 18
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["mysql_collations"]) ? $context["mysql_collations"] : null), $context["current_charset"], [], "array"));
            foreach ($context['_seq'] as $context["_key"] => $context["current_collation"]) {
                // line 19
                echo "                <tr class=\"";
                echo ((($this->getAttribute((isset($context["mysql_dft_collations"]) ? $context["mysql_dft_collations"] : null), $context["current_charset"], [], "array") == $context["current_collation"])) ? (" marked") : (""));
                echo "\">
                    <td>";
                // line 20
...
";
    ...
    {
        return new Twig_Source("", "server/collations/charsets.twig", "/home/ubuntu/workspace/phpMyAdmin/templates/server/collations/charsets.twig");
    }
}
